...
export class BoneToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class BoneToken extends ethereum.SmartContract {
  static bind(address: Address): BoneToken {
    return new BoneToken("BoneToken", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): BoneToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new BoneToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt,
  ): ethereum.CallResult<BoneToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new BoneToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
