...
export function getTokenDayData(token: Token, event: ethereum.Event): TokenDayData {
  ...
  if (tokenDayData === null) {
    ...
    tokenDayData.sellVolume = BIG_DECIMAL_ZERO
    tokenDayData.buyVolume = BIG_DECIMAL_ZERO
    ...
    tokenDayData.selltxn = BigInt.fromI32(0)
    tokenDayData.buytxn = BigInt.fromI32(0)
  }
